...
const projects = [
  {
    ...
    deadline: "2024-03-15",
    milestones: [
      { id: 1, title: "Project Setup & Planning", amount: 1000, status: "Completed", dueDate: "2024-01-20" },
      { id: 2, title: "Frontend Development", amount: 2000, status: "In Progress", dueDate: "2024-02-15" },
      { id: 3, title: "Backend API Development", amount: 1500, status: "Pending", dueDate: "2024-02-28" },
      { id: 4, title: "Testing & Deployment", amount: 500, status: "Pending", dueDate: "2024-03-15" },
    ],
    escrow: {
      totalAmount: 5000,
      releasedAmount: 1000,
    ...
    messages: [
      ...
      },
      {
        id: 2,
        sender: "freelancer",
        message: "Thank you! I'll have the user authentication ready by tomorrow.",
  ...
  },
  {
    ...
    deadline: "2024-02-10",
    milestones: [
      { id: 1, title: "Research & Wireframes", amount: 500, status: "Completed", dueDate: "2024-01-15" },
      { id: 2, title: "UI Design", amount: 1000, status: "Completed", dueDate: "2024-01-25" },
      { id: 3, title: "Prototyping", amount: 750, status: "In Review", dueDate: "2024-02-05" },
      { id: 4, title: "Final Delivery", amount: 250, status: "Pending", dueDate: "2024-02-10" },
    ],
    escrow: {
      totalAmount: 2500,
      releasedAmount: 1500,
    ...
    messages: [
      ...
      },
      {
        id: 2,
        sender: "client",
        message: "The designs look fantastic! Just a few minor adjustments needed.",
            ...
            {projects.map((project) => (
              <div
                ...
                className={`p-3 rounded-lg border cursor-pointer transition-colors ${
                  selectedProject.id === project.id ? "bg-accent" : "hover:bg-accent/50"
                }`}
              ...
              <TabsContent value="overview" className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="space-y-1">
                    ...
                    <div className="text-lg font-bold">${selectedProject.budget.toLocaleString()}</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-sm font-medium">Progress</div>
                    <div className="text-lg font-bold">{selectedProject.progress}%</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-sm font-medium">Start Date</div>
                    <div className="text-sm text-muted-foreground">{selectedProject.startDate}</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-sm font-medium">Deadline</div>
                    <div className="text-sm text-muted-foreground">{selectedProject.deadline}</div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex items-center space-x-3">
                      <Avatar className="h-10 w-10">
                        <AvatarImage src={`/placeholder.svg?height=40&width=40&text=C`} />
                        <AvatarFallback>C</AvatarFallback>
                      </Avatar>
                      <div>
                        <div className="font-medium text-sm">{selectedProject.client}</div>
                        <div className="text-xs text-muted-foreground">Client</div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Avatar className="h-10 w-10">
                        <AvatarImage src={`/placeholder.svg?height=40&width=40&text=F`} />
                        <AvatarFallback>F</AvatarFallback>
                      </Avatar>
                      <div>
                        <div className="font-medium text-sm">{selectedProject.freelancer}</div>
                      ...
                      <CardContent className="p-4">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-4 mt-2 text-sm text-muted-foreground">
                              <span className="flex items-center">
                                <DollarSign className="mr-1 h-3 w-3" />${milestone.amount.toLocaleString()}
                              </span>
                              <span className="flex items-center">
                          ...
                          <div className="flex items-center space-x-2">
                            {milestone.status === "In Review" && userRole === "client" && (
                              <>
                                <Button size="sm" variant="outline" className="bg-transparent">
                                  Request Changes
                                </Button>
              ...
              <TabsContent value="escrow" className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <Card>
                    <CardContent className="p-4">
                      ...
                      <div className="text-2xl font-bold">${selectedProject.escrow.totalAmount.toLocaleString()}</div>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-4">
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <div className="text-sm font-medium text-muted-foreground">Pending Release</div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Manage milestone payments and releases</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    {userRole === "client" && selectedProject.escrow.pendingAmount > 0 && (
                      <div className="p-4 border rounded-lg bg-yellow-50 dark:bg-yellow-950/20">
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          ${selectedProject.escrow.pendingAmount.toLocaleString()} is ready for release upon milestone
                          completion approval.
                        </p>
                        <Button size="sm">
                          <CheckCircle className="mr-2 h-4 w-4" />
                    ...
                    {userRole === "freelancer" && (
                      <div className="p-4 border rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          Your earnings are protected by escrow. Payments are released automatically upon milestone
                          approval.
                        </p>
