    ...
    <div className="space-y-4 max-w-5xl mx-auto p-4">
      ...
      {/* BankDetailsSection
          Props:
            ...
            accountHolderName → NEW field (PayoutSetupRequest.accountHolderName)
            accountNumber     → PayoutSetupRequest.accountNumber
            ifscCode          → PayoutSetupRequest.ifscCode
            onSave            → calls POST /api/freelancer/payout/setup
      */}
      <BankDetailsSection
        userId={userId}
