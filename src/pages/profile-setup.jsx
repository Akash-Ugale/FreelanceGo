...
import { User, Briefcase, Star, MapPin, Calendar, Plus, ArrowRight, CheckCircle } from "lucide-react"
...
useEffect(() => {
  async function fetchProfiles() {
    try {
      const response = await axios.get("/api/user-profiles") // Adjust your endpoint
      setExistingFreelancer(response.data.freelancer)
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Choose how you'd like to continue with your account</p>
          </div>
                    ...
                    <CardHeader className="pb-4">
                      <div className="flex items-start gap-4">
                        <Avatar className="h-16 w-16">
                          <AvatarImage
                            src={existingFreelancer.avatar || "/placeholder.svg"}
                        ...
                        <div className="flex-1">
                          <CardTitle className="text-xl mb-1">{existingFreelancer.name}</CardTitle>
                    ...
                    <CardContent className="pt-0">
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div className="text-center p-3 bg-white rounded-lg">
                          <div className="text-2xl font-bold text-primary">{existingFreelancer.completedJobs}</div>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {existingFreelancer.skills.slice(0, 3).map((skill) => (
                      ...
                      <Button onClick={() => handleContinueAsExisting("freelancer")} className="w-full" size="lg">
                ...
                {existingClient && (
                  <Card className="relative overflow-hidden border-2 border-blue-200 bg-blue-50/50">
                    ...
                    <CardHeader className="pb-4">
                      <div className="flex items-start gap-4">
                        <Avatar className="h-16 w-16">
                          <AvatarImage src={existingClient.avatar || "/placeholder.svg"} alt={existingClient.name} />
                          <AvatarFallback className="bg-primary text-primary-foreground text-lg">
                            {existingClient.name
                              .split(" ")
                              .map((n) => n[0])
                        ...
                        <div className="flex-1">
                          <CardTitle className="text-xl mb-1">{existingClient.name}</CardTitle>
                          <CardDescription className="text-base font-medium text-primary">
                            Client Account
                          </CardDescription>
                          <div className="flex items-center gap-4 mt-2 text-sm text-muted-foreground">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              Since {new Date(existingClient.joinedDate).getFullYear()}
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <CardContent className="pt-0">
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div className="text-center p-3 bg-white rounded-lg">
                          <div className="text-2xl font-bold text-primary">{existingClient.projectsPosted}</div>
                          <div className="text-sm text-muted-foreground">Projects Posted</div>
                        </div>
                        <div className="text-center p-3 bg-white rounded-lg">
                          <div className="text-2xl font-bold text-primary">{existingClient.freelancersHired}</div>
                          <div className="text-sm text-muted-foreground">Freelancers Hired</div>
                        </div>
                      </div>

                      <Button onClick={() => handleContinueAsExisting("client")} className="w-full" size="lg">
                        Continue as Client
                        <ArrowRight className="ml-2 h-4 w-4" />
                      </Button>
                    </CardContent>
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-6 flex items-center gap-2">
              ...
              {existingFreelancer || existingClient ? "Create Additional Profile" : "Create Your Profile"}
            </h2>
              ...
              {!existingFreelancer && (
                <Card className="cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-105 border-2 hover:border-primary/50">
                  ...
                  <CardContent className="pt-0">
                    ...
                    <Button onClick={() => handleCreateNewProfile("freelancer")} className="w-full" size="lg">
              ...
              {!existingClient && (
                <Card className="cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-105 border-2 hover:border-primary/50">
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardDescription className="text-base">Hire talented freelancers for your projects</CardDescription>
                  </CardHeader>
                  ...
                  <CardContent className="pt-0">
                    ...
                    <Button onClick={() => handleCreateNewProfile("client")} className="w-full" size="lg">
